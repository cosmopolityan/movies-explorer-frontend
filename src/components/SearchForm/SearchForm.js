...
const SearchForm = (props) => {
  ...
  const handleSubmit = (evt) => {
    ...
    if (!isInputValid) {
      ...
      onSubmit(movieValue); // не работает в сохраненных фильмах
    }
    console.log(movieValue, 'получили фильм по handleSubmit в SearchForm'); // здесь все ок в полном списке фильмов
  };
